...
\bibitem{aqila2026}
K. S. Aqila et al., ``Comparative Evaluation of SARIMA, FB Prophet, and LSTM for Hourly Demand Forecasting in Saudagar Kopi,'' 2026.

\bibitem{sandeep2025}
Sandeep V et al., ``Smart Sales Forecasting Machine Learning Models for Demand Prediction in Retail,'' 2025.

\bibitem{kamboj2025}
M. Kamboj et al., ``State-Level Drug Retail Sales Forecasting Using XGBoost and Facebook Prophet,'' 2025.

\bibitem{gartner2024}
T. Gärtner, C. Lippert, and S. Konigorski, ``Automated Demand Forecasting in Small to Medium-Sized Enterprises,'' 2024.

\bibitem{ganguly2024}
P. Ganguly and I. Mukherjee, ``Enhancing Retail Sales Forecasting with Optimized Machine Learning Models,'' 2024.

\bibitem{jatte2025}
H. Jatte et al., ``Optimization of Forecasting Performance in the Retail Sector Using Artificial Intelligence,'' 2025.
...
\bibitem{guler}
A. K. Güler et al., ``Forecasting Restaurant Sales with the Sensitivity of Weather Conditions and Special Days Using Facebook Prophet,'' \emph{Journal of Data Applications}, 2023.

\bibitem{susanto2026}
J. C. Susanto et al., ``Performance Analysis of Time Series Models to Predict Sales Activity of SMEs,'' 2026.

\bibitem{munawar2026}
M. A. Munawar and I. D. Sudirman, ``LSTM-Based Hourly Sales Forecasting in SME Food and Beverage Retail,'' 2026.

\bibitem{vyakarnam2025}
S. Vyakarnam et al., ``Optimizing Supply Chain Management for Small and Medium-Sized Businesses Using AI: A Comparative Analysis of GPT-4.5, Grok 3, Gemini 2.0, and DeepSeek R-1,'' \emph{SERA 2025}, 2025.

\bibitem{yuniarty2025}
Yuniarty et al., ``Technology Acceptance and Security Influences on AI Adoption among Small and Medium Enterprises,'' 2025.

\bibitem{aree2025}
T. Aree and P. Ueasangkomsate, ``Technology Adoption of MSMEs in Food Supply Chain: The Role of AI in Traceability and Transparency,'' 2025.

\bibitem{somjaipeng2026}
K. Somjaipeng and W. Jitsakul, ``Factors influencing audit quality through the acceptance and use of AI by auditors in Thailand affiliated with SMEs audit firms,'' 2026.

\bibitem{srivastava2026}
S. Srivastava et al., ``Predictive Marketing and Sales Analytics Using Machine Learning for Small and Medium E-Commerce Enterprises,'' 2026.

\bibitem{lalitha2025}
Lalitha R et al., ``Enhanced Sales Forecasting of Perishable and Non-Perishable Goods Using Weather Data with Insights on Imports and Price Sensitivity,'' 2025.

\bibitem{jain2024}
N. Jain et al., ``Weather-Integrated Recommendations for Food Choices with SHAP Explanation,'' 2024.

\bibitem{qureshi2024}
N. U. H. Qureshi et al., ``Demand Forecasting in Supply Chain Management for Rossmann Stores using Weather Enhanced Deep Learning Model,'' 2024.

\bibitem{rahmatillah2026}
I. Rahmatillah, Herwanto, and Sudirman, ``Evaluation of Optimized LSTM and Moving Average in SME Inventory Forecasting and Simulation,'' 2026.
...
\bibitem{aidpaf}
M. Padmavathy et al., ``AI-Driven Predictive Analytics for Sustainable Restaurant Operations and Waste Minimization,'' 2025.

\bibitem{smartstock}
K. Avuduri and M. L. V, ``Smart Stock: Automating Inventory Management for Small Warehouses with Real-Time Intelligence,'' 2025.

\bibitem{foodwaste_ml}
S. Chowdhury, S. Swetha, and P. Prasad, ``Predictive Analytics in Food Supply Chain and Waste Management,'' 2025.

\bibitem{sakuda2024}
G. Sakuda, J. Leon, and R. Rojas, ``Mobile Application for the Intelligent Management of Small Shops Using the GPT-4 Model,'' 2024.

\bibitem{janchidfah2026}
T. Janchidfah et al., ``A Mobile Application for Inventory Management to Support Digital Transformation in Small Retail Businesses,'' 2026.
