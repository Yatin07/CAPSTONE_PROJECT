...
def run():
    ...
    # We know in G1-PPT-Review-I.pptx, slide 9 is exactly the stale Methodology slide.
    print("Deleting stale Methodology (Slide 9)...")
    pres.Slides(9).Delete()
    ...
    # Insert slides 12-15 from src after slide 13
    pres.Slides.InsertFromFile(src_path, 13, 12, 15)
    
    print("Fixing ER Diagram (duplicate tables)...")
    # After the above insertions, ER Diagram is exactly slide 17.
    # We will search explicitly in slide 17 just to be safe.
    er_slide = pres.Slides(17)
    tables_seen = {}
    shapes_to_delete = []
