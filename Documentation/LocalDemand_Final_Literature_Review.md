# LocalDemand: Final Literature Review
...
**Author(s) & Year:** Lalitha R et al. (2025)
...
**Author(s) & Year:** Nikunj Jain et al. (2024)
...
**Author(s) & Year:** Nameer Ul Haq Qureshi et al. (2024)
...
**Author(s) & Year:** Groene and Zakharov (date unspecified)
...
**Author(s) & Year:** Güler et al. (date unspecified)
...
**Author(s) & Year:** Intan Rahmatillah et al. (2026)
...
**Model/Method used:** SARIMA, DeepAR, and Hybrid.
...
**Model/Method used:** Temporal-Fusion Neural Architecture (TFNA) + Waste-Aware LP.
...
**Model/Method used:** XGBoost-based demand forecasting.
...
**Model/Method used:** LSTM, XGBoost, and Random Forest.
...
**Author(s) & Year:** Gonzalo Sakuda et al. (2024)
...
**Author(s) & Year:** Thanakrit Janchidfah et al. (2026)
...
*Forecasting Restaurant Sales with Weather and Special Days using Facebook Prophet* (Güler et al.) OR *State-Level Drug Retail Sales Forecasting Using XGBoost and Facebook Prophet* (Kamboj et al., 2025). These share our core model (Prophet) combined with weather/holiday regressors.

**Primary Application Context Base Paper:**
*Comparative Evaluation of SARIMA, FB Prophet, and LSTM for Hourly Demand Forecasting in Saudagar Kopi* (Aqila et al., 2026) strongly matches the small food business (SME) environment.
